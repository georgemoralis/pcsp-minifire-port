...
unsigned int GUI_init() {
    ...
    gWindow = SDL_CreateWindow("PCSP", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED,800, 600,
...
static void endFrame() {
    ...
    ImGui::Begin("Minifire Window");
    ImVec2 textureSize = ImGui::GetWindowSize();
    textureSize.y = textureSize.x * (512.f / 1024.f);  // PSP ratio?
